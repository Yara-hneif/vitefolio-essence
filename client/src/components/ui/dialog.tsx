...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed z-[95] grid shadow-2xl border bg-background",
        "left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2",
        "w-[calc(100vw-2rem)] max-w-[42rem] sm:max-w-[48rem] lg:max-w-[56rem]",
        "max-h-[calc(100vh-2rem)] p-6 rounded-xl",
        ...
        "[min-width:18rem] [min-height:12rem]",
        className
      )}
      {...props}
    >
