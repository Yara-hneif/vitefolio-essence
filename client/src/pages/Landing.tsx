...
const AuthDialog = lazy(() => import('@/components/dialogs/AuthDialog'));
const Header = lazy(() => import('@/components/layout/partials/Header'));
const Footer = lazy(() => import('@/components/layout/partials/Footer'));
const StackPreview3D = lazy(() => import('@/components/ui/3d/StackPreview3D'));
const TiltCard = lazy(() => import('@/components/ui/3d/TiltCard'));
const ContactDialog = lazy(() => import('@/components/dialogs/ContactDialog'));
...
export default function Landing() {
  ...
  const features = [
    {
      ...
      desc: 'Build your distinctive site in minutes with professional templates & advanced customization.',
      color: 'from-blue-500 to-cyan-400',
    },
    {
      icon: <Palette className="h-7 w-7" />,
      title: 'Complete Customization',
      desc: 'Tweak design, colors, and fonts to reflect your identity.',
      color: 'from-purple-500 to-pink-400',
    },
    {
      icon: <Users className="h-7 w-7" />,
      title: 'Project Collaboration',
      desc: 'Connect projects with teammates and showcase teamwork.',
      color: 'from-green-500 to-emerald-400',
    },
    {
      icon: <Zap className="h-7 w-7" />,
      title: 'Quick Connect',
      desc: 'Auto-import profile data from GitHub, LinkedIn & more.',
  ...
  const portfolioTypes = [
    ...
    },
    {
      ...
      description: 'Display your creative work and design process',
    },
    {
      icon: <Share className="h-8 w-8" />,
      title: 'Business Portfolio',
      description: 'Professional presentation for entrepreneurs',
    },
  ];
  ...
  const parallax = useMemo(() => {
    if (isMobile || reduceMotion)
      return {
        p1: 'translate(0px,0px)',
        p2: 'translate(0px,0px)',
        p3: 'translate(0px,0px)',
        grid: 'translate(0px,0px)',
      };
    return {
      ...
      grid: `translate(${scrollY * 0.1}px, ${scrollY * 0.05}px)`,
    };
        ...
        <main className="container mx-auto max-w-screen-2xl px-[clamp(16px,4vw,32px)] overflow-x-hidden">
          ...
          <section id="features" className="section-padding relative rounded-3xl bg-muted/30 mt-8">
            <div className="relative z-10 mx-auto text-center mb-10 max-w-2xl">
              ...
              <h2 className="text-[clamp(1.75rem,4.5vw,2.5rem)] font-bold">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-[1100px] mx-auto">
              {features.map((f, i) => (
                <TiltCard key={i} className="rounded-2xl p-6 text-center">
                  <div
                    className={`mx-auto mb-4 h-16 w-16 flex items-center justify-center rounded-xl bg-gradient-to-br ${f.color} text-white`}
                  >
                    {f.icon}
                  </div>
          ...
          <section className="section-padding bg-muted/30 rounded-3xl">
            <div className="text-center mx-auto max-w-3xl">
              <h2 className="text-[clamp(1.75rem,4.5vw,2.5rem)] font-bold mb-2">
          ...
          <section
            id="pricing"
            className="section-padding bg-gradient-to-b from-muted/10 to-muted/30 rounded-3xl"
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              {/* Free */}
              <Card className="flex flex-col p-6 rounded-2xl border bg-card/50 backdrop-blur hover:shadow-lg transition">
                ...
                <CardContent className="flex-1 space-y-3 text-sm">
                  {['Basic portfolio', '1 project', 'Community support'].map((f, idx) => (
              ...
              {/* Pro */}
              <Card className="flex flex-col p-6 rounded-2xl border-2 border-primary shadow-xl bg-background hover:scale-[1.02] transition">
                <CardHeader className="pb-4 text-center">
                  <Badge className="mb-2 px-3 py-1">Most Popular</Badge>
...
function TrophyIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" className="h-6 w-6">
      <path
        fill="currentColor"
        d="M7 4h10v3a5 5 0 0 1-4 4.9V14h3v2H8v-2h3v-2.1A5 5 0 0 1 7 7V4Zm-2 1H3a4 4 0 0 0 4 4V8A3 3 0 0 1 5 5Zm16 0h-2a3 3 0 0 1-2 3v1a4 4 0 0 0 4-4Z"
      />
    </svg>
  );
}
