...
const About = () => {
  ...
  const timeline = [
    ...
    },
    {
      ...
      description:
        'Developed and maintained various client projects using modern web technologies.',
    },
    {
      year: '2019',
            ...
            <div>
              ...
              <div className="space-y-5 text-muted-foreground">
                <p>
                  ...
                  creating beautiful digital experiences. I specialize in building responsive,
                  user-friendly websites and applications that combine elegant design with powerful
                  functionality.
                </p>
                <p>
                  My journey in web development started during college when I discovered my passion
                  for bringing creative ideas to life through code. Since then, I've been
                  continuously learning and expanding my skills, embracing new technologies and
                  design trends.
                </p>
                <p>
                  I believe that great websites should not only look stunning but also provide
                  exceptional user experiences. My approach combines technical expertise with a keen
                  eye for design details, resulting in projects that are both visually impressive
        ...
        <div className="container px-4 md:px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {skills.map((skillGroup) => (
              ...
              >
                <div
                  className={`w-12 h-12 rounded-full bg-gradient-to-br ${skillGroup.color} flex items-center justify-center mb-4`}
                >
                  {skillGroup.icon}
                </div>
                        ...
                        <HoverCardContent className="glass">
                          <div className="text-sm">
                            ...
                            <p className="text-muted-foreground">
                              Experienced in building projects with {skill}
                            </p>
                          </div>
                        </HoverCardContent>
                      </HoverCard>
        ...
        <div className="container px-4 md:px-6 text-center relative z-10">
          <div className="glass p-8 md:p-12 rounded-2xl max-w-3xl mx-auto">
            ...
            <p className="max-w-2xl mx-auto mb-8 text-white/90">
              Interested in working together? Let's discuss your project and bring your ideas to
              life.
            </p>
