...
import { useAuth } from '@/utils/legacy/AuthProvider';
...
export default function AuthDialog({ open, onOpenChange }: Props) {
  ...
  const [loading, setLoading] = useState<'google' | 'github' | 'facebook' | 'linkedin_oidc' | null>(
    null
  );
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Use your favorite provider to get started in seconds.
          </DialogDescription>
        </DialogHeader>
